...
> Auto-generated by `generate-claude-md.sh` on 2026-05-25 18:56:16. Edit
...
Rules live under `.claude/rules/{common,typescript}/`. Implementers/verifiers
Read the relevant file BEFORE editing code — do NOT inline-import all rules
(wastes context on every prompt and every subagent spawn).
