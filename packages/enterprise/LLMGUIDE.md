...
| ----------------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `EntityId`              | `ddd-value-objects`   | The concrete class (preferred for consumers). `ddd-contracts`' own `EntityId` is aliased to `ContractsEntityId` instead of being dropped.                                                                                                                                                                                                                                                                             |
| `ContractsEntityId`     | `ddd-contracts`       | `ddd-contracts`' `EntityId` renamed on import (`export { EntityId as ContractsEntityId } from '@vytches/ddd-contracts'`) specifically to avoid clashing with the `ddd-value-objects` version.                                                                                                                                                                                                                         |
