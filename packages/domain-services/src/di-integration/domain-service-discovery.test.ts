...
import { DomainService, getDIDomainServiceMetadata, isDomainServicePendingDIRegistration } from '../domain-service.decorator';
...
describe('Domain Service DI Integration', () => {
  ...
  describe('@DomainService decorator with DI options', () => {
    ...
    it('should register metadata in DIDomainServiceMetadataRegistry', () => {
      @DomainService({
  ...
  describe('DomainServiceDiscoveryPlugin', () => {
  ...
  describe('DIDomainServiceMetadataRegistry', () => {
    beforeEach(() => {
      DIDomainServiceMetadataRegistry.clear();
    });
