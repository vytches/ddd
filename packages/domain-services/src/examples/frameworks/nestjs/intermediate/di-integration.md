...
**Focus**: Advanced @vytches-ddd/domain-services usage with @vytches-ddd/di integration
...
export class OrderFulfillmentService {
  ...
  constructor() {
    ...
    this.orderFulfillmentDomainService = VytchesDDD.resolve<OrderFulfillmentDomainService>(
  ...
  async initiateFulfillment(orderId: string): Promise<Result<OrderProcessingResult, Error>> {
    try {
      ...
      const result = await this.orderFulfillmentDomainService.initiateFulfillment(orderId);
...
export class OrderFulfillmentController {
  ...
  async initiateFulfillment(@Param('orderId') orderId: string) {
    ...
    const result = await this.orderFulfillmentService.initiateFulfillment(orderId);
...
- **@vytches-ddd/di Integration**: Uses VytchesDDD.resolve() for service location
- **Domain Service Decorators**: @DomainService decorator for automatic registration
