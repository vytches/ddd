...
// Core imports from @vytches-ddd packages
...
// Domain-specific imports (always import from your application)
import { 
  User, 
  Order, 
  CreateUserCommand,
...
// Type imports (prefer type imports for better tree-shaking)
import type { 
  IUnitOfWork,
  IRepository 
...
// Framework-specific imports (when needed)
import { Injectable } from '@nestjs/common'; // Only for framework integration
