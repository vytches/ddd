 ...
 * ddd-compliance-guardian. For users who want a plain functional baseline
 * without the lifecycle / event-bus / unit-of-work machinery of the
 * specialized variants, this is the minimal starting point.
 *
 ...
 * not a subclass — it stays as a minimal, infrastructure-free baseline.
 *
 * @public
 * @stable
 * @since 0.25.0
