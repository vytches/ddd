...
- **Event contracts** — `IDomainEvent`, `IEventStore`, `IEventBus`, and related interfaces
- **Capability system** — `Capability`, `CapabilityRegistry`, and opt-in capability interfaces
