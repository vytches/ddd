...
> **Foundation package providing core Domain-Driven Design primitives and base
> classes**

Essential building blocks for Domain-Driven Design including base classes for
entities, value objects, domain services, and common interfaces. This is the
foundation package that all other VytchesDDD packages depend on.
...
The fundamental distinction in DDD between objects with identity and objects
without:
...
interface IQueryableRepository<T extends IAggregateRoot>
...
describe('OrderProcessingService', () => {
  ...
  it('should process order successfully', async () => {
    ...
    expect(mockInventoryService.validateAvailability).toHaveBeenCalledWith(
      orderData.items
    );
