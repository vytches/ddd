...
/**
 * Main saga orchestrator interface
 * Responsible for saga lifecycle management and coordination
 */
export interface ISagaOrchestrator {
   ...
   */
  startSaga(event: IExtendedDomainEvent, context: ISagaExecutionContext): Promise<ISaga>;
...
/**
 * Result of saga event processing
 */
