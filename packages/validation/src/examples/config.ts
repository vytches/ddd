...
export const packageExampleConfig: PackageExampleConfig = {
  ...
  version: '1.0.0',
  description: 'Domain validation patterns with specifications, composite validation, and business rules',
  domain: 'Core',
  ...
  examples: [
    ...
    // Intermediate Examples
    {
      ...
      description: 'Complex specification composition with AND/OR logic and conditional validation rules',
      file: 'intermediate/example-1.md',
      tags: ['advanced-specification', 'composition', 'conditional-validation', 'logical-operators'],
    ...
    },
    {
      ...
      description: 'Centralized validation orchestration with multiple validation engines and error aggregation',
    ...
    },
    {
      ...
      description: 'Complex validation scenarios with multi-step validation and conditional business rules',
    ...
    // Advanced Examples
    {
      ...
      description: 'Extensible validation architecture with dynamic plugin loading and custom validation engines',
    ...
    },
    {
      ...
      description: 'Optimized validation with parallel execution, caching, and performance monitoring',
