...
console.log(
  "   - Test expects 'masking.sensitiveKeys' but implementation uses different structure"
);
console.log('   - LoggerConfiguration interface vs actual implementation mismatch');

console.log('\n3. BUILDER PATTERN ISSUES:');
console.log(
  "   - DefaultLogEventBuilder.withError() called with 'error!' but error might be undefined"
);
